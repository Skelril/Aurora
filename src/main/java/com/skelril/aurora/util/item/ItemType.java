...
public enum ItemType {
    ...
    ROSE_RED(ItemID.INK_SACK, 1, "Rose red", "rosered", "reddye"),
    CACTUS_GREEN(ItemID.INK_SACK, 2, "Cactus green", "cactusgreen", "greendye"),
    COCOA_BEAN(ItemID.INK_SACK, 3, "Cocoa beans", "cocoabeans", "cocobeans", "browndye"),
    LAPIS_LAZULI(ItemID.INK_SACK, 4, "Lapis lazuli", "lapislazuli", "bluedye"),
    PURPLE_DYE(ItemID.INK_SACK, 5, "Purple dye", "purpledye"),
    CYAN_DYE(ItemID.INK_SACK, 6, "Cyan dye", "cyandye"),
    LIGHT_GREY_DYE(ItemID.INK_SACK, 7, "Light grey dye", "lightgreydye"),
    ...
    SPAWN_EGG(ItemID.SPAWN_EGG, "Spawn Egg", "spawnegg", "spawn", "mobspawnegg"), // Should be 0
